...
export const MANGO_V4_ID = {
  testnet: new PublicKey('LehFymqUgQkZyUD2JedHgbTEcHNseyuLnWotwG7zPBB'),
  devnet: new PublicKey('LehFymqUgQkZyUD2JedHgbTEcHNseyuLnWotwG7zPBB'),
  'mainnet-beta': new PublicKey('LehFymqUgQkZyUD2JedHgbTEcHNseyuLnWotwG7zPBB'),
};
