...
// const NUM_USERS = 4;
// const PROGRAM_ID = 'LehFymqUgQkZyUD2JedHgbTEcHNseyuLnWotwG7zPBB';
...
//         oracle:btcPerp.oracle,
//         baseDecimals:btcPerp.baseDecimals,
//       maintBaseAssetWeight:btcPerp.maintBaseAssetWeight.toNumber(),
//       initBaseAssetWeight:btcPerp.initBaseAssetWeight.toNumber(),
//       maintBaseLiabWeight:btcPerp.maintBaseLiabWeight.toNumber(),
//       initBaseLiabWeight:btcPerp.initBaseLiabWeight.toNumber(),
//       baseLiquidationFee:btcPerp.baseLiquidationFee.toNumber(),
//       feePenalty:0.0004, // Changed
//       forceClose:false, // Changed
//       groupInsuranceFund:false, // Changed
//       impactQuantity : 0.0007, // Changed
//       initOverallAssetWeight:0.0008, // Changed
//       maintOverallAssetWeight:0.0009, // Changed
//       makerFee:0.0004, // Changed
//       takerFee:0.0005, // Changed
//       platformLiquidationFee:btcPerp.baseLiquidationFee.toNumber(),
// maxFunding:btcPerp.maxFunding.toNumber(),
// minFunding:btcPerp.minFunding.toNumber(),
// oracleConfig:btcPerp.oracleConfig,
// perpMarketIndex:btcPerp.perpMarketIndex,
// quoteDecimals:btcPerp.quoteDecimals,
// quoteMint:btcPerp.quoteLotSize.toNumber(),
// stablePriceGrowthLimit:0.05, // Changed
// stableSizeGrowthLimit:0.05, // Changed
// targetPeriodLength:100, // Changed
...
//     assert.isTrue(
//       positionA.getAverageEntryPrice(btcPerp).eq(new BN(99.0) as any),
//       'long entry price matches',
//     );
//     assert.isTrue(
//       positionB.getAverageEntryPrice(btcPerp).eq(new BN(101.0) as any)  ,
//       'short entry price matches',
//     );

//     assert.isTrue(
//       positionA.getBreakEvenPrice(btcPerp).eq(new BN(99.0) as any),
//       'long break even price matches',
//     );
//     assert.isTrue(
//       positionB.getBreakEvenPrice(btcPerp).eq(new BN(99.0) as any),
